...
<!----------------I'M DOING STUFF PAGE------------------>
            <a href="#doing_stuff"><h2 id="doing_stuff">What am I up to?</h2></a>
       ...
       <h2 id="contact">Where You Can Find Me:</h2>
        ...
        document.addEventListener("DOMContentLoaded", function(event) {
          ...
          var slideShow = {
            ...
            figData: [
                { caption: "Getting my diploma from the MMM Program at Syracuse University", src: "assets/ss/diploma-compressor.jpg"},
                { caption: "Me and my service dog, Taffy, at a Warrior Ride event", src: "assets/ss/meWIthACane-compressor.jpg" },
                { caption: "My dogs and I at Camp Unleashed", src: "assets/ss/meAndTaffy-compressor.jpg" },
                ...
                { caption: "Deployment to Saudi Arabia", src: "assets/ss/saudi.jpg" },
